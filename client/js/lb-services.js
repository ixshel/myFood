 ...
 */
  module.factory(
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/restaurants/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Restaurant.saucers.findById() instead.
            "prototype$__findById__saucers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/restaurants/:id/saucers/:fk",
              method: "GET",
            },

            // INTERNAL. Use Restaurant.saucers.destroyById() instead.
            "prototype$__destroyById__saucers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/restaurants/:id/saucers/:fk",
            ...
            // INTERNAL. Use Restaurant.saucers.updateById() instead.
            "prototype$__updateById__saucers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/restaurants/:id/saucers/:fk",
            ...
            // INTERNAL. Use Restaurant.saucers() instead.
            "prototype$__get__saucers": {
              isArray: true,
              url: urlBase + "/restaurants/:id/saucers",
              method: "GET",
            },

            // INTERNAL. Use Restaurant.saucers.create() instead.
            "prototype$__create__saucers": {
              url: urlBase + "/restaurants/:id/saucers",
              method: "POST",
            },

            // INTERNAL. Use Restaurant.saucers.destroyAll() instead.
            "prototype$__delete__saucers": {
              url: urlBase + "/restaurants/:id/saucers",
              method: "DELETE",
            },

            // INTERNAL. Use Restaurant.saucers.count() instead.
            "prototype$__count__saucers": {
              url: urlBase + "/restaurants/:id/saucers/count",
              method: "GET",
            },
    ...
    /**
     * @ngdoc object
     * @name lbServices.Restaurant.saucers
     * @header lbServices.Restaurant.saucers
     * @object
     * @description
     *
     * The object `Restaurant.saucers` groups methods
     * manipulating `Saucer` instances related to `Restaurant`.
     *
     * Call {@link lbServices.Restaurant#saucers Restaurant.saucers()}
     * to query all related instances.
     */
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `Saucer` object.)
             * </em>
             */
        R.saucers = function() {
          var TargetResource = $injector.get("Saucer");
          var action = TargetResource["::get::Restaurant::saucers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Restaurant.saucers#count
             * @methodOf lbServices.Restaurant.saucers
             *
             * @description
             *
             * Counts saucers of restaurant.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             *  - `count` – `{number=}` -
             */
        R.saucers.count = function() {
          var TargetResource = $injector.get("Saucer");
          var action = TargetResource["::count::Restaurant::saucers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Restaurant.saucers#create
             * @methodOf lbServices.Restaurant.saucers
             *
             * @description
             *
             * Creates a new instance in saucers of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.saucers.create = function() {
          var TargetResource = $injector.get("Saucer");
          var action = TargetResource["::create::Restaurant::saucers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Restaurant.saucers#createMany
             * @methodOf lbServices.Restaurant.saucers
             *
             * @description
             *
             ...
             * </em>
             */
        R.saucers.createMany = function() {
          var TargetResource = $injector.get("Saucer");
          var action = TargetResource["::createMany::Restaurant::saucers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Restaurant.saucers#destroyAll
             * @methodOf lbServices.Restaurant.saucers
             *
             * @description
             *
             * Deletes all saucers of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * This method returns no data.
             */
        R.saucers.destroyAll = function() {
          var TargetResource = $injector.get("Saucer");
          var action = TargetResource["::delete::Restaurant::saucers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Restaurant.saucers#destroyById
             * @methodOf lbServices.Restaurant.saucers
             *
             * @description
             *
             * Delete a related item by id for saucers.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             *
             *  - `fk` – `{*}` - Foreign key for saucers
             *
             * @param {function(Object,Object)=} successCb
             *   Success callback with two arguments: `value`, `responseHeaders`.
             *
             ...
             * This method returns no data.
             */
        R.saucers.destroyById = function() {
          var TargetResource = $injector.get("Saucer");
          var action = TargetResource["::destroyById::Restaurant::saucers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Restaurant.saucers#findById
             * @methodOf lbServices.Restaurant.saucers
             *
             * @description
             *
             * Find a related item by id for saucers.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.saucers.findById = function() {
          var TargetResource = $injector.get("Saucer");
          var action = TargetResource["::findById::Restaurant::saucers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Restaurant.saucers#updateById
             * @methodOf lbServices.Restaurant.saucers
             *
             * @description
             *
             * Update a related item by id for saucers.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.saucers.updateById = function() {
          var TargetResource = $injector.get("Saucer");
          var action = TargetResource["::updateById::Restaurant::saucers"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Saucer
 * @header lbServices.Saucer
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Saucer` model.
 *
 * ## Example
 *
 * See
 ...
 */
  module.factory(
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/saucers/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Saucer.comments.findById() instead.
            "prototype$__findById__comments": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/saucers/:id/comments/:fk",
              method: "GET",
            },

            // INTERNAL. Use Saucer.comments.destroyById() instead.
            ...
            // INTERNAL. Use Saucer.comments.updateById() instead.
            ...
            // INTERNAL. Use Saucer.comments() instead.
            "prototype$__get__comments": {
              isArray: true,
              url: urlBase + "/saucers/:id/comments",
              method: "GET",
            },

            // INTERNAL. Use Saucer.comments.create() instead.
            "prototype$__create__comments": {
              url: urlBase + "/saucers/:id/comments",
              method: "POST",
            },

            // INTERNAL. Use Saucer.comments.destroyAll() instead.
            "prototype$__delete__comments": {
              url: urlBase + "/saucers/:id/comments",
              method: "DELETE",
            },

            // INTERNAL. Use Saucer.comments.count() instead.
            "prototype$__count__comments": {
              url: urlBase + "/saucers/:id/comments/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Saucer#create
             * @methodOf lbServices.Saucer
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
            ...
            /**
             * @ngdoc method
             * @name lbServices.Saucer#createMany
             * @methodOf lbServices.Saucer
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Saucer#replaceOrCreate
             * @methodOf lbServices.Saucer
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/saucers/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Saucer#exists
             * @methodOf lbServices.Saucer
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/saucers/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Saucer#findById
             * @methodOf lbServices.Saucer
             *
             * @description
             *
             ...
             */
            "findById": {
              url: urlBase + "/saucers/:id",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Saucer#replaceById
             * @methodOf lbServices.Saucer
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/saucers/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Saucer#find
             * @methodOf lbServices.Saucer
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Saucer#findOne
             * @methodOf lbServices.Saucer
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/saucers/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Saucer#updateAll
             * @methodOf lbServices.Saucer
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/saucers/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Saucer#deleteById
             * @methodOf lbServices.Saucer
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/saucers/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Saucer#prototype$updateAttributes
             * @methodOf lbServices.Saucer
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Saucer#createChangeStream
             * @methodOf lbServices.Saucer
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/saucers/change-stream",
              method: "POST",
            },

            // INTERNAL. Use Restaurant.saucers.findById() instead.
            "::findById::Restaurant::saucers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/restaurants/:id/saucers/:fk",
            ...
            // INTERNAL. Use Restaurant.saucers.destroyById() instead.
            "::destroyById::Restaurant::saucers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/restaurants/:id/saucers/:fk",
            ...
            // INTERNAL. Use Restaurant.saucers.create() instead.
            "::create::Restaurant::saucers": {
              url: urlBase + "/restaurants/:id/saucers",
              method: "POST",
            },

            // INTERNAL. Use Restaurant.saucers.createMany() instead.
            "::createMany::Restaurant::saucers": {
              isArray: true,
              url: urlBase + "/restaurants/:id/saucers",
              method: "POST",
            },
            ...
            // INTERNAL. Use Restaurant.saucers.destroyAll() instead.
            "::delete::Restaurant::saucers": {
              url: urlBase + "/restaurants/:id/saucers",
              method: "DELETE",
            },

            // INTERNAL. Use Restaurant.saucers.count() instead.
            "::count::Restaurant::saucers": {
              url: urlBase + "/restaurants/:id/saucers/count",
              method: "GET",
            },
          }
            ...
            /**
             * @ngdoc method
             * @name lbServices.Saucer#patchOrCreate
             * @methodOf lbServices.Saucer
             *
             * @description
             *
        ...
        R["patchOrCreate"] = R["upsert"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Saucer#updateOrCreate
             * @methodOf lbServices.Saucer
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Saucer#destroyById
             * @methodOf lbServices.Saucer
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Saucer#removeById
             * @methodOf lbServices.Saucer
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Saucer#patchAttributes
             * @methodOf lbServices.Saucer
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Saucer#modelName
        * @propertyOf lbServices.Saucer
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Saucer`.
        */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Saucer.comments
     * @header lbServices.Saucer.comments
     * @object
     * @description
     *
     * The object `Saucer.comments` groups methods
     * manipulating `Comment` instances related to `Saucer`.
     *
     * Call {@link lbServices.Saucer#comments Saucer.comments()}
     * to query all related instances.
     */
        ...
        R.comments = function() {
          ...
          var action = TargetResource["::get::Saucer::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Saucer.comments#count
             * @methodOf lbServices.Saucer.comments
             *
             * @description
             *
             * Counts comments of saucer.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.comments.count = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::count::Saucer::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Saucer.comments#create
             * @methodOf lbServices.Saucer.comments
             *
             * @description
             *
        ...
        R.comments.create = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::create::Saucer::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Saucer.comments#createMany
             * @methodOf lbServices.Saucer.comments
             *
             * @description
             *
        ...
        R.comments.createMany = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::createMany::Saucer::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Saucer.comments#destroyAll
             * @methodOf lbServices.Saucer.comments
             *
             * @description
             *
        ...
        R.comments.destroyAll = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::delete::Saucer::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Saucer.comments#destroyById
             * @methodOf lbServices.Saucer.comments
             *
             * @description
             *
        ...
        R.comments.destroyById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::destroyById::Saucer::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Saucer.comments#findById
             * @methodOf lbServices.Saucer.comments
             *
             * @description
             *
        ...
        R.comments.findById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::findById::Saucer::comments"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Saucer.comments#updateById
             * @methodOf lbServices.Saucer.comments
             *
             * @description
             *
        ...
        R.comments.updateById = function() {
          var TargetResource = $injector.get("Comment");
          var action = TargetResource["::updateById::Saucer::comments"];
          return action.apply(R, arguments);
        };
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/comments/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Saucer.comments.create() instead.
            "::create::Saucer::comments": {
              url: urlBase + "/saucers/:id/comments",
              method: "POST",
            },

            // INTERNAL. Use Saucer.comments.createMany() instead.
            "::createMany::Saucer::comments": {
              isArray: true,
              url: urlBase + "/saucers/:id/comments",
              method: "POST",
            },
            ...
            // INTERNAL. Use Saucer.comments.destroyAll() instead.
            "::delete::Saucer::comments": {
              url: urlBase + "/saucers/:id/comments",
              method: "DELETE",
            },

            // INTERNAL. Use Saucer.comments.count() instead.
            "::count::Saucer::comments": {
              url: urlBase + "/saucers/:id/comments/count",
              method: "GET",
            },
          }
